...
${OBJECTDIR}/src/emedatadispatcherprocessor.o: src/emedatadispatcherprocessor.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/emedatadispatcherprocessor.o src/emedatadispatcherprocessor.cpp

${OBJECTDIR}/src/emedatagather.o: src/emedatagather.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/emedatagather.o src/emedatagather.cpp

${OBJECTDIR}/src/emsetting.o: src/emsetting.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/emsetting.o src/emsetting.cpp
