...
{
    _CCD_INSTRUCTION_CONNECT = 0x01,        // =1    
...
{
    _CCD_STATUS_DISCONNECT = 0x01,      // =0x1
    _CCD_STATUS_CONNECTING,             // =0x2
    _CCD_STATUS_DISCONNECTING,          // =0x3 
    _CCD_STATUS_WAITINGEXPOSURE,        // =0x4
...
{
    _CCD_WARN_NORMAL = 0x0,             // =0x0
    _CCD_WARN_TOPCOM = 0x1,             // =0x1
    _CCD_WARN_COOLER = 0x2,             // =0x2
    _CCD_WARN_FAN = 0x4,                // =0x4
    _CCD_WARN_IMG_TIMEOUT = 0x8,        // =0x8
    _CCD_WARN_SPACE_LESS100 = 0x10      // =0x10
};
...
{
    _CCD_ERROR_NORMAL = 0x0,                    // =0x0
    _CCD_ERROR_CCDCOM = 0x1,                    // =0x1
    _CCD_ERROR_EXPOSURE_START_TIMEOUT = 0x2,    // =0x2
    _CCD_ERROR_EXPOSURE_TIMEOUT = 0x4,          // =0x4
    _CCD_ERROR_READ_TIMEOUT = 0x8,              // =0x8
    _CCD_ERROR_EXPOSURE_STOP_TIMEOUT = 0x10,    // =0x10    
    _CCD_ERROR_EXPOSURE_ABORT_TIMEOUT = 0x20,   // =0x20
    _CCD_ERROR_SPACE_LESS10 = 0x40              // =0x40
};


/*!
 *------------------------------------------------------------------------------
 * @brief:       _AT_CCD_PROPERTY defines CCD's attributes.
 *------------------------------------------------------------------------------
 * @size:       208 bytes.
 * -----------------------------------------------------------------------------
 * @author Geniuswei
