...
${OBJECTDIR}/src/atccs_global.o: src/atccs_global.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/atccs_global.o src/atccs_global.cpp

${OBJECTDIR}/src/atccsaddress.o: src/atccsaddress.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/atccsaddress.o src/atccsaddress.cpp

${OBJECTDIR}/src/atccscontroller.o: src/atccscontroller.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/atccscontroller.o src/atccscontroller.cpp

${OBJECTDIR}/src/atccsdata.o: src/atccsdata.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/atccsdata.o src/atccsdata.cpp

${OBJECTDIR}/src/atccsdatahandler.o: src/atccsdatahandler.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/atccsdatahandler.o src/atccsdatahandler.cpp

${OBJECTDIR}/src/atccsdataprocessor.o: src/atccsdataprocessor.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/atccsdataprocessor.o src/atccsdataprocessor.cpp

${OBJECTDIR}/src/atccsdbaddress.o: src/atccsdbaddress.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/atccsdbaddress.o src/atccsdbaddress.cpp

${OBJECTDIR}/src/atccsexception.o: src/atccsexception.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/atccsexception.o src/atccsexception.cpp

${OBJECTDIR}/src/atccsexceptionhandler.o: src/atccsexceptionhandler.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/atccsexceptionhandler.o src/atccsexceptionhandler.cpp

${OBJECTDIR}/src/atccsmapmanager.o: src/atccsmapmanager.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/atccsmapmanager.o src/atccsmapmanager.cpp

${OBJECTDIR}/src/atccsonline.o: src/atccsonline.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/atccsonline.o src/atccsonline.cpp

${OBJECTDIR}/src/atccsqueue.o: src/atccsqueue.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/atccsqueue.o src/atccsqueue.cpp

${OBJECTDIR}/src/atccssetting.o: src/atccssetting.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/atccssetting.o src/atccssetting.cpp

${OBJECTDIR}/src/atccsthread.o: src/atccsthread.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/atccsthread.o src/atccsthread.cpp
