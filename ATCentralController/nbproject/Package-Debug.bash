...
OUTPUT_PATH=${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/atcentralcontroller
OUTPUT_BASENAME=atcentralcontroller
PACKAGE_TOP_DIR=atcentralcontroller/
...
cd "${TOP}"
makeDirectory "${NBTMPDIR}/atcentralcontroller/bin"
...
# Generate tar file
cd "${TOP}"
rm -f ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/package/atcentralcontroller.tar
cd ${NBTMPDIR}
tar -vcf ../../../../${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/package/atcentralcontroller.tar *
checkReturnCode
