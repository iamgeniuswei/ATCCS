...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/atcentralcontroller: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/atcentralcontroller ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/src/ATCCATController.o: src/ATCCATController.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ATCCATController.o src/ATCCATController.cpp

${OBJECTDIR}/src/ATCCLevel1DataProcessor.o: src/ATCCLevel1DataProcessor.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ATCCLevel1DataProcessor.o src/ATCCLevel1DataProcessor.cpp

${OBJECTDIR}/src/ATCCLevel2DataProcessor.o: src/ATCCLevel2DataProcessor.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ATCCLevel2DataProcessor.o src/ATCCLevel2DataProcessor.cpp
