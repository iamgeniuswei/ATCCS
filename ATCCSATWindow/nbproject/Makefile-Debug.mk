...
LDLIBSOPTIONS=../QWUIKit/dist/Debug/GNU-Linux/libQWUIKit.so.1.0.0
...
.build-conf: ${BUILD_SUBPROJECTS} nbproject/qt-${CND_CONF}.mk
	"${MAKE}" -f nbproject/qt-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libATCCSATWindow.so.1.0.0
