...
OUTPUT_PATH=${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/emgatherconsole
OUTPUT_BASENAME=emgatherconsole
PACKAGE_TOP_DIR=emgatherconsole/
...
cd "${TOP}"
makeDirectory "${NBTMPDIR}/emgatherconsole/bin"
...
cd "${TOP}"
makeDirectory "${NBTMPDIR}/emgatherconsole/bin"
copyFileToTmpDir "${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libATCCSEMCore.so" "${NBTMPDIR}/${PACKAGE_TOP_DIR}bin/libATCCSEMCore.so" 0755
...
cd "${TOP}"
makeDirectory "${NBTMPDIR}/emgatherconsole/bin"
copyFileToTmpDir "${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libEMOrm.so" "${NBTMPDIR}/${PACKAGE_TOP_DIR}bin/libEMOrm.so" 0755
...
# Generate tar file
cd "${TOP}"
rm -f ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/package/emgatherconsole.tar
cd ${NBTMPDIR}
tar -vcf ../../../../${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/package/emgatherconsole.tar *
checkReturnCode
