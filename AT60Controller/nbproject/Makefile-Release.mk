...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/at60controller: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/at60controller ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/src/at60ccdcontroller.o: src/at60ccdcontroller.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/at60ccdcontroller.o src/at60ccdcontroller.cpp

${OBJECTDIR}/src/at60exceptiondisplayer.o: src/at60exceptiondisplayer.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/at60exceptiondisplayer.o src/at60exceptiondisplayer.cpp

${OBJECTDIR}/src/at60filtercontroller.o: src/at60filtercontroller.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/at60filtercontroller.o src/at60filtercontroller.cpp

${OBJECTDIR}/src/at60focuscontroller.o: src/at60focuscontroller.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/at60focuscontroller.o src/at60focuscontroller.cpp
...
${OBJECTDIR}/src/at60setting.o: src/at60setting.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/at60setting.o src/at60setting.cpp

${OBJECTDIR}/src/at60slavedomecontroller.o: src/at60slavedomecontroller.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/at60slavedomecontroller.o src/at60slavedomecontroller.cpp
